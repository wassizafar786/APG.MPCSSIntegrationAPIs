...
{
    public interface IAccountRegistrationHostAdapter
    {
        public Task<ServiceResponse> Execute(RegistrationAccountInputDto baseInternalRequest, MPCSSRecordRequest mpcssMessageType);
    }
}
