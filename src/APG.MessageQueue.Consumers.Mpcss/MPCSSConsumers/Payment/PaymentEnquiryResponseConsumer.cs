...
public class PaymentEnquiryResponseConsumer : IMessageHandlerBase<Envelope>
{
    ...
    public PaymentEnquiryResponseConsumer(IMPCSSCommunicationLogService mpcssCommunicationLogService,
        IDigitalTransactionAppService digitalTransactionAppService, IMPCSSMessageBuilder mpcssMessageBuilder)
    {
...
public class PaymentEnquiryResponseConsumerDefinition : IMessageListenerDefinition<PaymentEnquiryResponseConsumer>
{
    public string DestinationQueue => MPCSSQueues.PaymentEnquiryResponseQueue;
}
